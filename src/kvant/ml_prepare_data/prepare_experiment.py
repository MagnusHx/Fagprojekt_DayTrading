...
def main():
    ...
    parser.add_argument("--cusum-h", type=float, default=0.02)
    parser.add_argument("--lookback", type=int, default=96)
    parser.add_argument("--barrier-width", type=int, default=None, help="Legacy vertical barrier width in minutes.")
    parser.add_argument("--barrier-width-periods", type=int, default=24)
    parser.add_argument("--barrier-height-pct", type=float, default=5.0)
    parser.add_argument(
        "--feature-selection-top-k",
        type=int,
        default=0,
        help="Optional train-only primary-side feature selection. Use 0 to keep the full paper-style feature set.",
    )
